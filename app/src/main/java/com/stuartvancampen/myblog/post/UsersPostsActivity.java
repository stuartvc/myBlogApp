 ...
 */
public class UsersPostsActivity extends PostsActivity {

    private User mUser;

    public static Intent create(Context context, User user) {
        Intent startIntent = new Intent(context, UsersPostsActivity.class);
    ...
    protected Fragment constructFragment() {
        return UsersPostsFragment.create(mUser);
    }
}
